        ...
        <div className='row-h-100 justify-content-end align-items-center mt-5'>
          <div className='col-md-4 bg-white p-4 shadow rounded login-form-container mt-5'>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <input type="email" className="form-control" name="email" value={registro.email} onChange={handleChange} placeholder='Correo electrónico' />
              </div>
              <div className="mb-3">
                <input type="password" className="form-control" name="contrasenia" value={registro.contrasenia} onChange={handleChange} placeholder='Contraseña' />
                {error && <p className='text-danger error-login'>Verifique su contraseña</p>}

              </div>
              <button type="submit" className="btn btn-iniciar-sesion">Continuar</button>
              ...
              <a href="/crearcuenta" className="btn btn-iniciar-sesion-dark w-100">Crear cuenta</a>
            </form>
